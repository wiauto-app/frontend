...
const CONTAINER_HEIGHT = "calc(100vh - 10rem)";
  ...
  return (
    <div className="space-y-6 pb-20">
      <div className="flex gap-5">
        <Card className="flex-1 overflow-auto" style={{ height: CONTAINER_HEIGHT }}>
          <CardHeader className="flex items-center justify-between gap-3 border-b border-gray-100 ">
            <div>
            ...
            {isLoadingInbox ? (
              ...
              <div className="p-8 text-center">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Cuando lleguen alertas o leads, aparecerán aquí en tiempo
                  real.
                </p>
              </div>
            ) : (
        ...
        <div className="w-96 space-y-6">
          <div className=" flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
            ...
            <Button nativeButton={false} render={<Link href="/vehiculos" />}>
