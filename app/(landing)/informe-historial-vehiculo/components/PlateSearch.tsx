      ...
      <div className='container-custom relative z-10 mx-auto px-4 py-10 sm:px-6 lg:py-14'>
        <div className='grid items-center gap-10 lg:grid-cols-2 lg:gap-16'>
          <div className='flex flex-col gap-5'>
            ...
            <div className='space-y-3'>
              ...
              <p className='max-w-lg text-base leading-relaxed text-slate-500 sm:text-lg'>
                Consulta el historial completo de cualquier vehículo en segundos
                y compra con total seguridad.
              </p>
            </div>
                ...
                <Tabs defaultValue='plate'>
                  ...
                  <TabsContent value='plate' className='mt-0'>
                    <div className='relative'>
                      ...
                      >
                        <span className='flex size-4 items-center justify-center rounded-full border border-slate-300 text-[10px] text-slate-400'>
                          ?
                        </span>
                        <span className='leading-tight text-[11px]'>
                          ¿Dónde
                          <br className='sm:hidden' /> encontrarla?
                        </span>
                      </button>
                    </div>
                  </TabsContent>
                  ...
                  <TabsContent value='vin' className='mt-0'>
                    <div className='relative'>
                      ...
                      >
                        ...
                        <span className='leading-tight text-[11px]'>
                          ¿Dónde
                          <br className='sm:hidden' /> encontrarlo?
                        </span>
                      </button>
                    </div>
                  </TabsContent>
          ...
          <div className='relative flex justify-center lg:justify-end'>
            <div
              className='pointer-events-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 size-130 sm:size-140 rounded-full bg-[radial-gradient(circle_at_center,#DBEAFE_0%,#EBF3FF_55%,transparent_75%)] opacity-80'
              aria-hidden
            />
            <div
              className='pointer-events-none absolute -right-6 -top-6 hidden h-28 w-28 bg-[radial-gradient(#93c5fd_1.5px,transparent_1.5px)] bg-size-[12px_12px] opacity-50 lg:block'
              aria-hidden
            />
