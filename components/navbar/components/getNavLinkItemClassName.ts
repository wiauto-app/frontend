...
export const getNavLinkItemClassName = (
  ...
  if (variant === "mobile") {
    return cn(
      "flex min-h-11 w-full items-center border-b border-slate-100 px-1 py-3 text-sm font-semibold text-slate-900 transition-colors duration-200 hover:text-[#0061F2]",
