...
export const PromotionPlans = ({ data }: { data: StrapiHero }) => {
      ...
      <Hero
        ...
        leftContent={
          <>
            ...
            />
            <Card className="bg-[#F7F8FC] shadow-none z-10 border-none">
        ...
        floatingContent={
          image_url ? (
            <div className="pointer-events-none absolute top-0 right-0 z-0 flex h-full items-center justify-end pr-4 [perspective:1200px] lg:pr-10">
              <div
                className="origin-right transform-[rotateY(-18deg)] transition-transform duration-500 ease-out will-change-transform"
