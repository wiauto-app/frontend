...
export function SegurosSecuritySection() {
  return (
    <section className="py-10 sm:py-12" style={{ backgroundColor: "#EBF2FF" }}>
      <div className="container-custom mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <Button
              className="mt-8 rounded-md inline-flex items-center text-sm font-semibold p-4  flex-row gap-2"
              style={{ backgroundColor: BRAND_BLUE }}
              asChild
            >
              <Link href={CONFIDENZA_WEBSITE}>
