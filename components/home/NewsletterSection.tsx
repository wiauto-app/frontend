  ...
  return (
    <SectionContainer className="py-14 lg:py-20" style={{ backgroundColor: BRAND_BLUE_LIGHT }}>
      <div className="mx-auto max-w-sm sm:max-w-md md:max-w-2xl text-center">
        <p className="text-lg md:text-sm font-semibold sm:text-base" style={{ color: BRAND_BLUE }}>
          {data.subtitle}
        </p>
        <h2 className="mt-2 text-xl md:text-2xl font-bold text-slate-900 sm:text-3xl lg:text-[2rem]">
          {data.title}
        </h2>
