          ...
          <div className='grid grid-cols-1 divide-y lg:divide-y-0 lg:divide-x divide-slate-100 lg:grid-cols-[1.8fr_1.3fr_1.1fr]'>
            <div className='p-5 sm:p-7 flex flex-col justify-between'>
              <div>
                ...
                <div className='relative mt-4 flex flex-col sm:flex-row items-center sm:items-center min-h-35 rounded-2xl overflow-hidden bg-slate-50/50 sm:bg-slate-50/30 p-3 sm:p-3'>
                  <div className='absolute inset-0 sm:w-2/3 overflow-hidden pointer-events-none'>
                    <Image
                      ...
                      aria-hidden
                    />
                    <div className='absolute inset-0 bg-linear-to-b from-transparent via-white/80 to-white sm:bg-linear-to-r sm:from-transparent sm:via-white/70 sm:to-white' />
                  </div>
            ...
            <div className='p-6 sm:p-7 flex flex-col items-center justify-center gap-3 text-center'>
              <Button
                size='lg'
                className='h-12 w-full max-w-55 rounded-xl bg-primary text-sm font-bold text-white shadow-md hover:bg-primary/95 transition-all'
              >
