...
export function ConcesionariasHero() {
  ...
  return (
    <div className="relative overflow-hidden">
      <Image sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 43vw" src={HERO_BG} alt="Concesionarios" fill className="object-cover" />
      ...
      <div className="relative z-10 container-custom mx-auto px-4 py-14 sm:px-6 sm:py-16">
        <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-3xl">
            ...
            <p className="mt-1 max-w-xl text-base text-blue-100 sm:text-base">
              Encuentra concesionarios verificados y confiables cerca de ti.
            </p>

            <form
              onSubmit={handleSearch}
              className="mt-5 flex max-w-2xl items-stretch overflow-hidden rounded-xl bg-white shadow-xl"
            >
              <input
              ...
              <Button
                ...
                className="h-auto shrink-0 rounded-none bg-[#0061F2] px-5 hover:bg-[#0050c8] sm:px-6 outline-none border-none"
