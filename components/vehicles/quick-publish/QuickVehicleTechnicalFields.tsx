  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        <ControllerInput name="transmission_type" control={form.control} label="Transmisión">
          {({ field }) => (
        ...
        <ControllerInput name="traction_id" control={form.control} label="Tracción">
          {({ field, fieldState }) => (
            <TractionsSelector
              value={field.value as string | undefined}
              onValueChange={field.onChange}
        ...
        <ControllerInput name="power" control={form.control} label="Potencia (CV o kW)">
          {({ field, fieldState }) => (
            <Input
              {...field}
        ...
        <ControllerInput name="displacement" control={form.control} label="Cilindrada (cc)">
          {({ field, fieldState }) => (
            <Input
              {...field}
              value={field.value == null ? "" : String(field.value)}
