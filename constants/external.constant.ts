...
/** CDN público de media (`https://media.wiauto.es`). Pathnames: `/{bucket}/{key}`. */
export const MEDIA_URL = process.env.NEXT_PUBLIC_MEDIA_URL;
export const GOOGLE_MAPS_API_KEY = process.env.GOOGLE_ANALYTICS_ID;
export const GOOGLE_ANALYTICS_ID = process.env.GOOGLE_TAG_MANAGER_ID;
