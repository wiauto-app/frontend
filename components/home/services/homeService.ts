...
const HOME_POPULATE_QUERY =
  "/homepage?populate[homeSeo][populate][shareImage]=true&populate[homeHero][populate][backgroundImage]=true&populate[homeHero][populate][actionLinks]=true&populate[homeAppAdvertisment][populate][appMockup]=true&populate[homeFeatures][populate][feature][populate][icon]=true&populate[homeNewsletter]=true&populate[processSection][populate][tabs][populate][image]=true";
